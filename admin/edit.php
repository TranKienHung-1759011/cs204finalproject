    ...
    <div class="container-fluid">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h5 class="text-center">Editing</h5>
                    <?php 
                        if(isset($_GET['id'])){
                            $id=$_GET['id'];
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <h5 class="text-center">Doctor detail</h5>
                            ...
                            <h5 class="my-3">Username: <?php echo $row['doctorusername']; ?></h5>
                        ...
                        <div class="col-md-4">
                            <h5 class="text-center">Edit Salary</h5>
                            <?php 
                            ...
                            <form action="" method="POST">
                                ...
                                autocomplete="off" placeholder="enter salary" value="<?php echo $row['salary'] ?>">
