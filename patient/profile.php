                                ...
                                <div class="col-md-6">
                                    ...
                                    if(isset($_POST['upload'])){
                                        ...
                                        if(empty($img)){
                                            ...
                                            $query="UPDATE patient SET profileimg='$img' WHERE patientusername='$patient'";
                                            $res=mysqli_query($connect,$query);
                                            if($res){
                                ...
                                <div class="col-md-6">
                                    ...
                                    if (isset($_POST['change_uname'])){
                                        ...
                                        if(empty($uname)){
                                            ...
                                            $query = "UPDATE patient SET patientusername = '$uname' WHERE patientusername = '$patient'";
                                            $res=mysqli_query($connect,$query);
                                            if($res){
                                    ...
                                    if(isset($_POST['change_pass'])){
                                        ...
                                        if($old!=$row['patientpassword']){
                                            ...
                                            $query ="UPDATE patient SET patientpassword = '$new' WHERE patientusername = '$patient'";
